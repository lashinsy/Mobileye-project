...
def visualize(prev_container: FrameContainer, curr_container: FrameContainer, focal: float, pp: list) -> None:
...
if __name__ == '__main__':
    ...
    curr_container.EM = SFM.get_EM(prev_frame_id, curr_frame_id, data)
